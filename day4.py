...
puzzle_input = """hcl:5d90f0 cid:270 ecl:#66dc9c hgt:62cm byr:1945 pid:63201172 eyr:2026
...
for passport in passports:
    ...
    for passport_info_bit in passport_info:
     ...
     #   count += 1
    #dieme die me die me die me die me die me die me
        #die me die me die me die me die me die me die me die me die me
        #die me die me die me die me die me die me die me die me die me
        #die me die me die me die me die me die me die me die me die me die me
        #die me die me die me
        #die me die me die me die me die me die me die me die me die me
        #die me die me die me die me die me die me die me die me die me
        #die me die me die me die me die  me die me die me die me die me die me
        #die me die me die me die me die me die me die me die me die me
        ...
        #die me die me die me die me die me die me die me die me die me die me
    if all([
        1920 <= int(key_value_dict.get('byr', 0)) <= 2002,
        2010 <= int(key_value_dict.get('iyr', 0)) <= 2020,
        2020 <= int(key_value_dict.get('eyr', 0)) <= 2030,
        check_valid_hgt(key_value_dict.get('hgt', None)),
        re.match(r"^#[0-9a-f]{6}$", key_value_dict.get('hcl', '')),
        key_value_dict.get('ecl', '') in ['amb', 'blu', 'brn', 'gry', 'grn', 'hzl', 'oth'],
        check_pid(key_value_dict.get('pid', None)),
        ]):
        count += 1
        
#kms kms kms kms kms kms kms kms kms kms kms kms kms kms kms kms kms kms
        #kms kms kms kms kms kms kmskmskmskmskmskmskmskmskms
        #kmskmskmskmskmskmskmskmskmskmskmskmskmskmskmskms
        ##############################
        #################################
        #################################
        #################################
